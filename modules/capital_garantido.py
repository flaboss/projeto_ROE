...
def capital_garantido(df_cap_garantido: pd.DataFrame) -> pd.DataFrame:
    ...
    df_cap_garantido["lucro_max"] = (
        df_cap_garantido.call_strike - df_cap_garantido.acao_vlr + df_cap_garantido.credito_operacao
    )
    df_cap_garantido["custo_total"] = (
        df_cap_garantido.call_premio - df_cap_garantido.acao_vlr - df_cap_garantido.put_premio
    )
